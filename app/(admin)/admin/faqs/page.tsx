  ...
  return (
    <div className="space-y-6 pb-16">
      ...
      <AdminModal
        ...
        title={editingFaq ? "Edit Consultation FAQ" : "Create Consultation FAQ"}
        description="Provide clear, expert answers for travelers exploring trip details."
        maxWidth="lg"
      >
      ...
      {viewingFaq && (
        <AdminModal
          ...
          onClose={() => { setViewModalOpen(false); setViewingFaq(null); }}
          title="FAQ Details"
          description="Detailed view of selected FAQ entry"
          maxWidth="lg"
        >
