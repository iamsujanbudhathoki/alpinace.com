      ...
      <article className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header className="pt-4 pb-8 space-y-5">
          ...
          <div className="flex items-center gap-3">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-amber-50 text-amber-900 border border-amber-200/80 shadow-2xs">
          ...
          {/* Headline */}
          <h1 className="font-heading text-2xl sm:text-4xl md:text-5xl font-extrabold text-slate-950 tracking-tight leading-tight">
            {post.title}
          </h1>
              ...
              {relatedPosts.map((related) => (
                ...
                >
                  <div className="relative aspect-16/10 w-full overflow-hidden bg-slate-100">
                    ...
                    <span className="absolute top-3 left-3 bg-slate-950/80 backdrop-blur-xs text-amber-400 text-xs font-semibold uppercase tracking-wider px-2 py-0.5 rounded-md">
                      {related.category}
                    </span>
                  </div>
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between space-y-2">
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-500 pt-2 border-t border-stone-100">
