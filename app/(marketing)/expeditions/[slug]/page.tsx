          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-white text-slate-900 p-6 rounded-2xl border border-slate-200 shadow-xs">
              <div className="space-y-1 border-r border-slate-100 pr-4">
                ...
                <span className="text-xs sm:text-sm font-extrabold block text-gold-600">{expedition.peakHeightM.toLocaleString()} meters</span>
              </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center text-xs font-heading font-extrabold tracking-wider text-slate-900">
                    ...
                    <span className="text-xs font-bold text-gold-700 bg-gold-100 px-2.5 py-1 rounded-md">{calculatorClimbers} {calculatorClimbers === 1 ? "Person" : "People"}</span>
                  </div>
                ...
                <div className="pt-4 border-t border-slate-100 flex justify-between items-end">
                  <div>
                    ...
                    <span className="text-xs text-gold-700 block font-extrabold">Includes Sherpa crew &amp; permits</span>
                  </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
              {inquirySubmitted ? (
                ...
                <form onSubmit={handleInquirySubmit} className="space-y-4">
                  ...
                  >
                    Inquire for {calculatorClimbers} Climbers
                  </button>
                </form>
              )}
            </div>
