...
export function TermsAndConditionsContent() {
  ...
  return (
    <div className="bg-white rounded-xl border border-stone-200 p-6 sm:p-10 text-zinc-700 text-sm leading-relaxed font-normal terms-content">
      <div
        ...
        className="
          ...
          prose-a:text-stone-950 prose-a:underline hover:prose-a:text-yellow-600
