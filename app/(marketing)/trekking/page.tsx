            ...
            <div className="bg-white w-full max-w-xs h-full p-6 overflow-y-auto flex flex-col justify-between shadow-2xl">
              ...
              <div className="pt-6 border-t border-slate-200 flex gap-3 mt-6">
                <button
                  ...
                  className="w-1/2 py-2.5 rounded-xl border border-slate-200 text-slate-700 font-bold text-xs hover:bg-slate-50 cursor-pointer"
                >
                  Reset
                </button>
                <button
      ...
      {selectedBookingTrip && (
        <PublicBookingModal
          ...
          trip={{
            ...
            difficulty: selectedBookingTrip.difficulty,
