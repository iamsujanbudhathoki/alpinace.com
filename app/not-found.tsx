...
import { Compass, Home, Mountain, Sparkles, MapPin, ChevronRight, PhoneCall, ShieldCheck } from "lucide-react";
...
export const metadata = {
  title: "404 - Mountain Pass Not Found | AlpineAce",
  description: "The page or expedition route requested could not be found.",
};
...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-slate-950 text-white">
      ...
      <main className="flex-1 relative overflow-hidden flex flex-col justify-center py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto w-full text-center space-y-8 z-10">
          ...
          <div className="relative select-none my-2">
            <h1 className="text-8xl sm:text-[12rem] font-heading font-extrabold tracking-tighter leading-none bg-gradient-to-b from-amber-200 via-amber-400 to-emerald-500 bg-clip-text text-transparent drop-shadow-2xl">
              404
            </h1>
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <span className="text-xs sm:text-lg font-black uppercase tracking-[0.3em] text-slate-400/30">
