              ...
              <div className="space-y-4 pr-1">
                <div className="bg-emerald-50/60 p-4 rounded-xl border border-emerald-200/80 space-y-2">
                  <div className="flex items-center gap-2 text-emerald-900 font-bold">
                    ...
                    <span>What&apos;s Included in Expedition Price</span>
                  </div>
                  <textarea
                    rows={4}
                    placeholder="e.g. Summit Climbing Royalty Fee, 1:1 IFMGA Sherpa Leader, Summit Oxygen Bottles & Regulator, Full Basecamp Kitchen Staff, Helicopter Evacuation Support"
                ...
                <div className="bg-rose-50/60 p-4 rounded-xl border border-rose-200/80 space-y-2">
                  <div className="flex items-center gap-2 text-rose-900 font-bold">
                    ...
                    <span>What&apos;s Excluded from Expedition Price</span>
                  </div>
                  <textarea
                    rows={4}
                    placeholder="e.g. International Flights to Kathmandu, Personal High Altitude Gear & Boots, Summit Bonus for Sherpa, Medical & Search Evacuation Insurance"
