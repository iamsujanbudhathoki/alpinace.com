                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
                  ...
                  <div className="bg-white p-3.5 rounded-lg border border-slate-200 space-y-1">
                    ...
                    <div className="text-sm font-extrabold text-blue-700 truncate hover:underline cursor-pointer">
                      {watchTitle
                        ? `${watchTitle} | Alpine Ace Himalayan Trekking`
                        : "Trek Package Title Preview"}
                    </div>
                    <div className="text-xs text-slate-800 font-semibold line-clamp-2 leading-relaxed">
                      {watchMetaDesc || "Brief summary for search engines and social cards..."}
                    </div>
                  </div>
                </div>
        ...
        <div className="space-y-4 py-2 text-xs max-h-[500px] overflow-y-auto pr-1">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-2 grid grid-cols-2 gap-3 bg-slate-50 p-4 rounded-xl border border-slate-200">
              ...
              <div>
                <span className="text-slate-600 font-semibold block text-[11px]">Max Altitude:</span>
                <span className="text-slate-950 font-bold flex items-center gap-1 mt-0.5">
              ...
              <div>
                <span className="text-slate-600 font-semibold block text-[11px]">Difficulty:</span>
                <span className="text-slate-950 font-bold">{initialData?.difficulty || "—"}</span>
              </div>
              <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px]">
            ...
            <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
              <span className="text-slate-500 font-medium block">Meals</span>
          ...
          {initialData?.shortDesc && (
            <div className="space-y-1">
              <span className="font-bold text-slate-900 block">Short Description:</span>
          ...
          {/* Permits */}
          <div className="space-y-1">
            <span className="font-bold text-slate-900 block">Required Permits:</span>
