    ...
    <div className="fixed bottom-6 right-4 sm:right-6 z-50 flex flex-col items-center gap-2.5 print:hidden">
      ...
      {whatsappUrl && (
        <a
          ...
          className="relative flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 bg-[#25D366] hover:bg-[#20bd5a] active:scale-95 text-white rounded-full shadow-xl shadow-emerald-500/20 transition-all duration-300 hover:scale-105 cursor-pointer"
        >
