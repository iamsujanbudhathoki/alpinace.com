            ...
            <div className="flex items-center gap-2 pt-1">
              {settings.facebookUrl && (
                <a
                  ...
                  aria-label="Facebook"
                  className="w-10 h-10 rounded-sm bg-stone-100 border border-stone-200/80 text-[#1877F2] hover:bg-stone-200 flex items-center justify-center transition-colors cursor-pointer"
                >
              ...
              {settings.instagramUrl && (
                <a
                  ...
                  className="w-10 h-10 rounded-sm bg-stone-100 border border-stone-200/80 text-[#E4405F] hover:bg-stone-200 flex items-center justify-center transition-colors cursor-pointer"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {settings.youtubeUrl && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="w-10 h-10 rounded-sm bg-stone-100 border border-stone-200/80 text-[#FF0000] hover:bg-stone-200 flex items-center justify-center transition-colors cursor-pointer"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {settings.linkedinUrl && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="w-10 h-10 rounded-sm bg-stone-100 border border-stone-200/80 text-[#0A66C2] hover:bg-stone-200 flex items-center justify-center transition-colors cursor-pointer"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
