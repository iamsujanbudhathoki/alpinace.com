            ...
            <div className="flex items-center gap-2.5 pt-2">
              ...
              {settings.instagramUrl && (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-stone-100/90 border border-stone-200 flex items-center justify-center hover:bg-[#E4405F]/10 hover:border-[#E4405F]/30 hover:scale-110 transition-all duration-200 shadow-2xs group cursor-pointer"
                  title="Instagram"
                >
                  <svg className="w-4 h-4 fill-[#E4405F] group-hover:scale-105 transition-transform" viewBox="0 0 24 24">
