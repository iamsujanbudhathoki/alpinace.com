            ...
            <div className="flex items-center gap-3 pt-2">
              {settings.facebookUrl && (
                <a
                  ...
                  aria-label="Facebook"
                  className="w-10 h-10 rounded-md bg-blue-50/80 text-[#1877F2] hover:bg-blue-100 flex items-center justify-center transition-all cursor-pointer hover:scale-105"
                >
              ...
              {settings.instagramUrl && (
                <a
                  ...
                  className="w-10 h-10 rounded-md bg-pink-50/80 text-[#E4405F] hover:bg-pink-100 flex items-center justify-center transition-all cursor-pointer hover:scale-105"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {settings.youtubeUrl && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="w-10 h-10 rounded-md bg-red-50/80 text-[#FF0000] hover:bg-red-100 flex items-center justify-center transition-all cursor-pointer hover:scale-105"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              {settings.linkedinUrl && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                  className="w-10 h-10 rounded-md bg-sky-50/80 text-[#0A66C2] hover:bg-sky-100 flex items-center justify-center transition-all cursor-pointer hover:scale-105"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
