            ...
            <div className="shrink-0 flex items-center gap-4">
              ...
              {isBooked ? (
                ...
                <button
                  type="button"
                  onClick={onBookClick}
                  className="bg-[#eab308] hover:bg-yellow-400 text-stone-950 font-bold text-xs sm:text-sm px-4.5 py-2.5 rounded-sm shadow-sm hover:shadow-md transition-all flex items-center gap-2 cursor-pointer group"
                >
