          ...
          return (
            <div key={f.id || idx} className="group">
              <button
                ...
                className="w-full text-left flex items-start justify-between gap-4 py-4 cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-700/40 rounded-xs transition-colors"
              >
                <span
