    ...
    <section className="py-16 sm:py-20 bg-stone-50 border-t border-b border-stone-200 text-stone-900 text-center">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-4">
          <Link
            href="/contact"
            className="btn-accent w-full sm:w-auto text-sm px-7 py-3"
          >
            Get in Touch &rarr;
          </Link>
          ...
          {phone && (
            <a
              ...
              className="btn-secondary w-full sm:w-auto text-sm px-7 py-3 flex items-center justify-center gap-2"
            >
