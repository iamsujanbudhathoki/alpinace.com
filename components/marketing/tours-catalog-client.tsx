...
export function ToursCatalogClient({
  ...
  const [maxDuration, setMaxDuration] = useState<number>(initialFilterOptions?.maxDuration || 10);
  ...
  const isDefaultFilter =
    ...
    selectedType === "All" &&
    maxDuration >= (filterOptions?.maxDuration || 10) &&
    sortBy === "rating";
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-slate-900 pt-16 sm:pt-20 pb-20 font-sans">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mt-6 sm:mt-8">
        ...
        <div className="mt-12 sm:mt-14 bg-white text-slate-900 rounded-sm p-6 sm:p-8 border border-stone-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm">
