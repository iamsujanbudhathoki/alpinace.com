...
export function ToursCatalogClient({
  ...
  const initialMaxDuration = maxDurationParam ? parseInt(maxDurationParam, 10) : (initialFilterOptions?.maxDuration || 14);
          ...
          <div className="space-y-1.5">
            ...
            <div className="py-1">
              <input
                ...
                style={getSliderFillStyle(tourFillPct)}
                    ...
                    <Link href={`/tours/${tour.slug}`} className="block flex-1 flex flex-col justify-between">
                      <div>
                        ...
                        <div className="relative aspect-[16/10] w-full overflow-hidden bg-stone-950">
                          <Image
                            src={tour.image || "/mountain-placeholder.jpg"}
                            alt={tour.title}
                            fill
                        ...
                        <div className="flex items-center justify-between pt-2.5">
                          <div>
                            <span className="text-[11px] text-stone-500 block">
                              {tour.groupPricingEnabled && tour.groupPricing && tour.groupPricing.length > 0 ? "Price from" : "From"}
                            </span>
                            <span className="text-base font-bold text-stone-900">
                              ${(tour.groupPricingEnabled && tour.groupPricing && tour.groupPricing.length > 0
                                ? getLowestGroupPrice(tour.groupPricing, tour.priceUSD || 0)
                                : (tour.priceUSD || 0)
