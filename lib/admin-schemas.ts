...
export const trekSchema = z.object({
  ...
  difficulty: z.nativeEnum(TrekDifficulty),
...
export const bookingSchema = z.object({
  ...
  packageType: z.nativeEnum(PackageCategoryType),
  ...
  permitStatus: z.nativeEnum(PermitStatus),
